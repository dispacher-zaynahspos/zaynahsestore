    ...
    items: [
      {
        ...
        product: {
          ...
          price: 1200,
          images: [{ url: 'https://jqwqgiqfvjdxaohzvjuv.supabase.co/storage/v1/object/public/product-images/sample1.webp', isPrimary: true }]
        },
        selectedVariant: {
          color: 'Blue',
          size: 'Medium'
      ...
      },
      {
        ...
        product: {
          ...
          price: 700,
          images: [{ url: 'https://jqwqgiqfvjdxaohzvjuv.supabase.co/storage/v1/object/public/product-images/sample2.webp', isPrimary: true }]
        },
        selectedVariant: {},
...
export async function POST(
  ...
  try {
    ...
    const mergedData = { ...mockData, settings };
